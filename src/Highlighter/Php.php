...
class Php extends AbstractHighlighter
{
	...
	protected $keywords = [    // http://nl3.php.net/manual/en/reserved.php
        '__halt_compiler',
        'abstract',
        'and',
        'array',
	...
	protected $constants = [        // http://nl3.php.net/manual/en/reserved.constants.php
		'PHP_VERSION',
		'PHP_MAJOR_VERSION',
		'PHP_MINOR_VERSION',
		'PHP_RELEASE_VERSION',
	...
	public function highlight()
    {
		$this->keys[] = [
			...
			'end'	=> ['<?', '<?php'],
			'css'	=> 'php-script-tag',
			'callback'	=> [new Html(), 'getHighlightedCode']
        ];
		$this->keys[] = [
			'start'	=> ['<?', '<?php', '?>'],
			'css'	=> 'php-script-tag'
		...
		$this->keys[] = [
			'start'	=> '$',
			'end'	=> array_merge($this->whitespace, $this->operators, $this->brackets, [',', ';']),
			'css'	=> 'php-var',
			'includeEnd'	=> false
        ];
		$this->keys[] = [
		...
		$this->keys[] = [
			'start'	=> get_defined_functions()['internal'],
			'css'	=> 'php-function',
			'startPre'	=> '[^a-zA-Z0-9_]',
			'startSuf'	=> '[^a-zA-Z0-9_]'
        ];
