...
namespace FvCodeHighlighter\Geshi;
...
//        $result = substr($result, 1, -1);
    ...
    protected function load_language($filename) {
        ...
        $style_filename = substr($filename, 0, -4) . '.style.php';
    ...
    */
    protected function _optimize_regexp_list_tokens_to_string(&$tokens, $recursed = false) {
        ...
        if (!$recursed) {
            ...
            static $callback_2;
            if (!isset($callback_2)) {
                $callback_2 = static function ($matches) {
