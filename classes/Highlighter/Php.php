...
class FvCodeHighlighter_Highlighter_Php extends FvCodeHighlighter_Highlighter {
	...
	protected $_keywords = array(	// http://nl3.php.net/manual/en/reserved.php
		'array',
		'as',
		'break',
		'case',
	...
	protected $_constants = array(		// http://nl3.php.net/manual/en/reserved.constants.php
		'PHP_VERSION',
		'PHP_MAJOR_VERSION',
		'PHP_MINOR_VERSION',
		'PHP_RELEASE_VERSION',
	...
	protected $_functions = array(		// http://www.php.net/quickref.php
	...
	public function highlight() {
		$this->_keys[] = array(
			...
			'end'	=> array('<?', '<?php'),
			'css'	=> 'php-script-tag',
			'callback'	=> array(new FvCodeHighlighter_Highlighter_Html(), 'getHighlightedCode')
		);
		$this->_keys[] = array(
			'start'	=> array('<?', '<?php', '?>'),
			'css'	=> 'php-script-tag'
		...
		$this->_keys[] = array(
			'start'	=> '$',
			'end'	=> array_merge($this->_whitespace, $this->_operators, $this->_brackets, array(',', ';')),
			'css'	=> 'php-var',
			'includeEnd'	=> false
		);
		$this->_keys[] = array(
			'start'	=> $this->_operators,
			'css'	=> 'php-operator'
		);
		$this->_keys[] = array(
			'start'	=> $this->_numbers,
		...
		$this->_keys[] = array(
			'start'	=> $this->_brackets,
			'css'	=> 'php-brackets'
		);
		$this->_keys[] = array(
			'start'	=> $this->_varTypes,
			'css'	=> 'php-var-type',
			'startPre'	=> '[^a-zA-Z0-9_]',
			'startSuf'	=> '[^a-zA-Z0-9_]'
		);
		$this->_keys[] = array(
			'start'	=> $this->_constants,
			'css'	=> 'php-constant',
			'startPre'	=> '[^a-zA-Z0-9_]',
			'startSuf'	=> '[^a-zA-Z0-9_]'
		);
		$this->_keys[] = array(
			'start'	=> $this->_keywords,
			'css'	=> 'php-keyword',
			'startPre'	=> '[^a-zA-Z0-9_]',
			'startSuf'	=> '[^a-zA-Z0-9_]'
		);
		$this->_keys[] = array(
			'start'	=> $this->_functions,
			'css'	=> 'php-function',
			'startPre'	=> '[^a-zA-Z0-9_]',
			'startSuf'	=> '[^a-zA-Z0-9_]'
		);
		...
		$this->setCode( '<span class="php">' . $parser->getParsedCode() . '</span>' );
